var SQLITE3ORM = function () {
    ...
    INSTANCE.getLastCreation = function (statements, callback) {
        var query = "SELECT * FROM " + statements.entity + " WHERE 1 ORDER BY incidence.id DESC LIMIT 1";
        statements["type"] = "single";
        utils.executeQuery(query, {}, statements, callback);
    };
